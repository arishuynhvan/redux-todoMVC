...
/** The TodoList components displays all the active items in the list it
  * has been given if the filter props has been set to active
  */
describe('TodoList', () => {
  it('renders a list with only the active items if the filter is active', () => {
    ...
    ); //Directly assign status to prop
    const filter = 'active';
    const component = renderIntoDocument(
      <TodoList filter={filter} todos={todos} />
    );//Directly instantiate TodoList with filter as its props
